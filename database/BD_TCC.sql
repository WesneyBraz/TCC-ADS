...
NOME_CAT VARCHAR(45) UNIQUE NOT NULL);
...
SELECT COD_PROD, NOME_PROD, CATEGORIA_PROD, DESCRICAO_PROD, ESTOQUE_PROD, VALOR_PROD, NOME_FANTASIA_FOR
FROM TBL_PRODUTO PR
INNER JOIN TBL_FORNECEDOR FR ON FR.COD_FOR = PR.COD_FOR where cod_prod = '1';
...
VALUES
('abc','abc','abc','10,6','10.2','1');

SELECT COD_PROD, NOME_PROD FROM TBL_PRODUTO WHERE NOME_PROD LIKE "%t%";