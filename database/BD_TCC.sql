#CREATE DATABASE BD_TESTE; -- #CRIA UM BANCO DE DADOS
#SHOW DATABASES; -- #APRESENTA OS BANCOS DE DADOS EXISTENTES
#USE BD_TESTE; -- #INDICA QUAL BANCO DE DADOS SERÁ UTILIZADO
#SELECT DATABASE(); -- #EXIBI QUAL BANCO DE DADOS ESTA SENDO UTILIZADO
#DROP DATABASE BD_TESTE; -- #APAGA UM BANCO DE DADOS SELECIONADO
#DROP TABLE TBL_ATIVIDADE; -- #APAGA UMA TABELA DO BANCO DE DADOS EM USO
#CREATE TABLE TBL_TESTE(); -- #CRIA UMA TABELA 
#SHOW TABLES; -- #EXIBE AS TABELAS EXISTENSTES DO BANCO DE DADOS
#INSERT INTO TBL_ATIVIDADE -- #INSERI DADOS NA TABELA
#SELECT * FROM TBL_ATIVIDADE; -- #EXIBI OS DADOS EXISTENTES NA TABELA 
#ALTER TABLE BD_TESTE; -- #ALTERA A ESTRUTURA DE UMA TABELA 
...
DROP tables TBL_ORDEM_DE_SERVICO;
INSERT INTO TBL_CLIENTE
(NOME_CLI, CPF_CLI) VALUES ('WESNEY teste','11111111111');

INSERT INTO TBL_ORDEM_DE_SERVICO
(DATA_INICIO, DESCRICAO_DA_ATIVIDADE, DIAGNOSTICO, PRODUTO) VALUES ('2021-05-09 00:23:00','BBB','BBB','BBB');

select * from TBL_CLIENTE;


select * from tbl_ordem_de_servico;
delete from tbl_cliente where nome = 'wesneytrajanobraz';
