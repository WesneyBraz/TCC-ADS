...
select * from tbl_solicitacaofunc;

SELECT EMAIL_FUN FROM TBL_FUNCIONARIO WHERE EMAIL_FUN = '{$vmail}';

INSERT INTO tbl_Solicitacao (Email_sol, Rash_sol) VALUES ('murilocdsan@gmail.com', '32321dsaa');
UPDATE TBL_EMPRESA SET SENHA_EMP = 'dnsjabiu312' WHERE EMAIL_EMP = 'murilocdsan@gmail.com';
SELECT RASH_SOL FROM TBL_SOLICITACAOfunc WHERE EMAIL_SOL = 'murilocdsan@gmail.com' AND STATS_SOL = 0;
...
DELETE FROM TBL_DEPARTAMENTO WHERE COD_DEP = '10';

SELECT COD_CLI, CPF_CLI, NOME_CLI, EMAIL, TELEFONE_MOVEL, TELEFONE_FIXO, 
...
SELECT EMAIL_EMP FROM TBL_EMPRESA WHERE EMAIL_EMP = 'murilocdsan@gmail.com';

SELECT *FROM TBL_DEPARTAMENTO WHERE COD_DEP != '0';

UPDATE TBL_FUNCIONARIO SET SENHA_FUN = '$vrashsenha' WHERE EMAIL_FUN = '$vmail';