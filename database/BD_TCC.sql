...
DELETE FROM TBL_DEPARTAMENTO WHERE COD_DEP = '1';
...
SELECT CUSTO, LUCRO, TIPO, NS, DATA_INICIO, DATA_FIM, 
DESCRICAO_DA_ATIVIDADE, DIAGNOSTICO, STATOS, PRODUTO, NOME_FUN, COD_SER, NOME_CLI  
FROM TBL_ORDEM_DE_SERVICO OS
