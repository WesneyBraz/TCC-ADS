                ...
                <div class="col-md-10 ml-auto mr-auto">
                    <div class="card card-upgrade">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-4">Alterar uma Ordem de Serviço:</h3>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="" class="formOS" id="frmCadastro" onsubmit="validarOS()">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="valorOs">Custo:</label><input value="<?php echo $retorno['CUSTO'];?>"
                                             type="text" id="valorOs" name="valorOs" class="form-control valor"
                                                style="display:inline-block" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="lucro">Lucro:</label><input value="<?php echo $retorno['LUCRO'];?>"
                                            type="text" id="lucro" name="lucro"
