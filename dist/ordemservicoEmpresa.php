                ...
                <div class="col-md-10 ml-auto mr-auto">
                    <div class="card card-upgrade">
                        <div class="card-header">
                            <h2 class="text-center my-3">Adicione uma Ordem de Serviço:</h2>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="" class="formOS" id="frmCadastro">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="valorOs">Custo:</label><input type="text" id="valorOs" name="valorOs" class="form-control valor" style="display:inline-block" placeholder="Ex: 1.000" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="lucro">Lucro:</label><input type="text" id="lucro" name="lucro" class="form-control valor" style="display:inline-block" placeholder="Ex: 2.000" />
                                        </div>
                                    </div>
                                </div>
